    ...
    public static void run() throws IOException {
        ...
        for (int step = 0; step < numSteps; step++) {
            ...
            for (int gradAccumStep = 0; gradAccumStep < gradAccumSteps; gradAccumStep++) {
                ...
                // dL/dl1preact = dL/dl1 * dl1/dl1preact = dl1 * tanhDerivative(l1preact)
                // somehow i got this wrong earlier and the model did better
                Matrix dl1preact = dl1.multiply(l1preact.tanhDerivative()); // [1, 20]
